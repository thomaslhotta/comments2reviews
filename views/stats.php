...
?>
		...
		<tr>
			<td class="stars">
				<?php if ( $val > 0 ) : ?><a href="<?php echo esc_url( $url )?>"><?php endif;?>
			...
			<td style="width:100%">
				<?php if ( $val > 0 ) : ?><a href="<?php echo esc_url( $url )?>"><?php endif;?>
					<div class="progress">
		        		<div class="progress-bar" role="progressbar" aria-valuenow="<?php echo esc_attr( $val ) ?>"
				             aria-valuemin="0" aria-valuemax="100" style="width: <?php echo esc_attr( $val )?>%;">
		            	</div>
					</div>
				<?php if ( $val > 0 ) : ?></a><?php endif;?>
		    </td>
